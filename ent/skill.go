...
func (e SkillEdges) UsersOrErr() ([]*Member, error) {
	if e.loadedTypes[0] {
		return e.Users, nil
	}
...
func (s *Skill) QueryUsers() *MemberQuery {
	return NewSkillClient(s.config).QueryUsers(s)
}

// QueryTeams queries the "teams" edge of the Skill entity.
func (s *Skill) QueryTeams() *TeamQuery {
	return NewSkillClient(s.config).QueryTeams(s)
}
