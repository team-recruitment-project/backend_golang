...
func (pq *PositionQuery) QueryTeam() *TeamQuery {
...
func (pq *PositionQuery) WithTeam(opts ...func(*TeamQuery)) *PositionQuery {
	query := (&TeamClient{config: pq.config}).Query()
...
func (pq *PositionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Position, error) {
	...
	if query := pq.withTeam; query != nil {
		if err := pq.loadTeam(ctx, query, nodes, nil,
			func(n *Position, e *Team) { n.Edges.Team = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (pq *PositionQuery) loadTeam(ctx context.Context, query *TeamQuery, nodes []*Position, init func(*Position), assign func(*Position, *Team)) error {
